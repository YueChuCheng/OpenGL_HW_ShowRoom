...
out vec3 v3N[LIGHT_NUM]; // 輸出 Normal 在 Tangent Space 座標下的方向
out vec3 v3L[LIGHT_NUM]; // 輸出 Light Direction 在 Tangent Space 座標下的方向
out vec3 v3E[LIGHT_NUM]; // 輸出 View Direction 在 Tangent Space 座標下的方向
